...
import com.sanidhya.config.JwtProvider;
import com.sanidhya.exception.UserException;
import com.sanidhya.model.PasswordResetToken;
import com.sanidhya.model.User;
import com.sanidhya.repository.PasswordResetTokenRepository;
import com.sanidhya.repository.UserRepository;
...
//		List<User> users= userRepository.findAllUserByUserIds(userIds);
    ...
    public void sendPasswordResetEmail(User user) {
        ...
        sendEmail(user.getEmail(), "Account Password Reset", "Click the following link to reset your password: http://localhost:3000/reset-password?token=" + resetToken);
    }
