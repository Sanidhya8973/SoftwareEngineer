package _07__Hibernate._03__Hibernate_Mapping_Annotations._03__ManyToOne.unidirectional_flow.config;
    ...
    public static SessionFactory getSessionFactory() {
        ...
        if (sessionFactory == null) {
            ...
            Supplier<Properties> properties = () -> {
                ...
                property.put(Environment.URL, "jdbc:mysql://127.0.0.1:3306/hibernate_many2one_relationship?useSSL=false");
